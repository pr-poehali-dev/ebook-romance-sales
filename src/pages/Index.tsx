...
const BOOKS = [
  ...
  { id: 2, title: 'Сквозь стекло', author: 'Марина Орлова', price: 299, old: 0, rating: 4.7, tag: 'Новинка', cover: COVER_2, desc: 'Она думала, что знает мужа как себя. Но стекло между ними оказалось не прозрачным — а зеркальным.' },
